...
class ReplicaDatasetCache(Dataset):
    def __init__(self, data_dir, train_ids=None, test_ids=None, img_h=None, img_w=None):
        ...
        # choose key-frames for training by evenly sampling from sequences 
        # total_num = 900
        # step = 5
        ...
        self.train_samples = {'image_path': [],
                            'image': [], 'depth': [],
                            'semantic': [], 'T_wc': [],
                            'instance': []}

        self.test_samples = {'image_path': [],
                            'image': [], 'depth': [],
                            'semantic': [], 'T_wc': [],
                            'instance': []}
       ...
       # training samples
        for idx in train_ids:
            image_path = self.rgb_list[idx]
            # image_name = os.path.basename(self.rgb_list[idx]).split('.')[0]
            ...
            self.train_samples["image_path"].append(image_path)
        ...
        for idx in test_ids:
            ...
            self.test_samples["image_path"].append(image_path)
